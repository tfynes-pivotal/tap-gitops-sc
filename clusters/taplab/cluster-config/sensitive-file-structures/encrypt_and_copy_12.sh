...
cp ./sso-credentials-secret.sops.yaml /Users/thomasfynes/PIVOTAL/TAP/tap-powertools/tap-installer-scripts/tap-gitops-sc/clusters/taplab/cluster-config/config/tap-install/
